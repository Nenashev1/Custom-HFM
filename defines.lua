...
country = {
	...
	GOLD_TO_WORKER_PAY_RATE = 0.7, -- Multiplier for how much money gold pays to pops
	...
	PROVINCE_OVERSEAS_PENALTY = 0.008, -- Each province req. this many goods flagged as overseas penalty 
	...
	POP_GROWTH_COUNTRY_CACHE_DAYS = 360, -- period of cached pop growth (used for player)
...
economy = {
	...
	MAX_FACTORY_MONEY_SAVE = 3500,	-- how much money is stored maximum in a factory.
	...
	FACTORY_PURCHASE_MIN_FACTOR = 0.9,			-- the lowest % of its daily needs a factory will purchase
...
military = {
	...
	POP_SIZE_PER_REGIMENT = 2500,
	SOLDIER_TO_POP_DAMAGE = 0.52,
	...
	LEADER_PRESTIGE_LAND_GAIN = 0.6, -- extra speed gain on prestige for land combat
	LEADER_PRESTIGE_NAVAL_GAIN = 0.6, -- extra speed gain on prestige for naval combat
...
pops = {
	...
	PROMOTION_ASSIMILATION_CHANCE = 0.0001,
